    ...
    <MotionConfig reducedMotion='user'>
      <WorkWrapper id='projects'>
        ...
        >
          <ProjectLink
            title='AmbrosiaLab'
            href={`/${router.locale}/projects/ambrosialab`}
          ...
          <ProjectLink
            title='theripper93'
            href={`/${router.locale}/projects/theripper93`}
          ...
          <ProjectLink
            title='Levels 101'
            href={`/${router.locale}/projects/levels101`}
          ...
          <ProjectLink
            ...
            href={`/${router.locale}/projects/draculafoundry`}
